...
const ParticlesBackground = dynamic(() => import('@/components/ui/ParticlesBackground').then(mod => mod.ParticlesBackground), { ssr: false });
...
function AnimatedSection({ children, className = '', delay = 0, immediate = false }: { children: React.ReactNode; className?: string; delay?: number; immediate?: boolean }) {
        ...
        <div className="container-nutriflow flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group mr-12 shrink-0">
            <div className="p-1 overflow-visible">
              <Image src="/logos/isotipo.png" alt="NutriFlow" width={40} height={40} className="h-10 w-auto object-contain dark:brightness-125" priority />
            </div>
        ...
        <div className="container-nutriflow relative z-10 py-16 md:py-24">
          <div className="mx-auto">
            ...
            <div className="text-center max-w-4xl mx-auto mb-16 space-y-8">
              ...
              {/* CTAs */}
              <AnimatedSection delay={400} immediate>
            ...
            <AnimatedSection delay={500} immediate>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
                {/* Large card — AI Coach (left column, full height) */}
                <div className="md:col-span-1 group relative overflow-hidden rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl p-8 hover:shadow-2xl hover:shadow-emerald-500/20 hover:-translate-y-1 transition-all duration-500 min-h-[280px] flex flex-col justify-between">
                  ...
                  <div className="relative z-10 mt-6">
                    <div className="flex items-center gap-2 text-xs font-bold text-fuchsia-600 dark:text-fuchsia-400 uppercase tracking-widest">
                ...
                <div className="md:col-span-2 grid grid-cols-2 gap-4">
                  ...
                  <div className="group relative overflow-hidden rounded-[1.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg p-6 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-500">
            ...
            {/* Stats row */}
            <AnimatedSection delay={600} immediate>
        ...
        <div className="container-nutriflow relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {TESTIMONIALS.map((testimonial, index) => (
              <AnimatedSection key={index} delay={index * 150} immediate>
          ...
          <div className="grid md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-1 overflow-visible">
                  <Image src="/logos/isotipo.png" alt="NutriFlow" width={40} height={40} className="h-10 w-auto object-contain dark:brightness-125" />
                </div>
