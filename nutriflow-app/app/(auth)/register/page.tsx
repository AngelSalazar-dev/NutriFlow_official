...
function RegisterForm() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-slate-50 dark:bg-slate-950 overflow-hidden relative transition-colors duration-500">
      <ParticlesBackground />
      {/* Form Side */}
      <div className="w-full lg:w-1/2 flex flex-col pt-8 pb-12 px-6 sm:px-10 lg:p-14 z-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl border-r border-slate-200 dark:border-slate-800 h-screen overflow-y-auto custom-scrollbar shadow-[20px_0_40px_-15px_rgba(0,0,0,0.05)]">
        <div className="w-full max-w-lg mx-auto">
          <Card className="w-full shadow-none border-0 bg-transparent p-2 sm:p-4">
            {/* Header / Logo */}
