...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-slate-50 dark:bg-slate-950 relative overflow-hidden transition-colors duration-500">
      <ParticlesBackground />
      {/* Form Side */}
      <div className="flex-1 lg:max-w-lg lg:w-1/2 flex flex-col justify-center px-6 sm:px-10 py-8 lg:p-14 z-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border-r border-slate-200 dark:border-slate-800 shadow-[20px_0_40px_-15px_rgba(0,0,0,0.05)]">
