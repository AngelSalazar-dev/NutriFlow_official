...
type Translations = {
  ...
  // Checkout Modal
  checkout_selected_plan: string;
  checkout_secure_checkout: string;
  checkout_upgrade_now: string;
  checkout_upgrade_desc: string;
  checkout_verifying: string;
  checkout_verifying_desc: string;
  checkout_welcome_elite: string;
  checkout_success_desc: string;
  checkout_receipt_id: string;
  checkout_date: string;
  checkout_amount_paid: string;
  checkout_verified_payment: string;
  checkout_save_pdf: string;
  checkout_go_dashboard: string;
  checkout_encrypted: string;
  // Profile
  prof_title: string;
  prof_name: string;
  prof_email: string;
...
const t: Record<LangCode, Translations | Partial<Translations>> = {
  en: {
    ...
    checkout_secure_checkout: 'Secure Checkout',
    checkout_upgrade_now: 'Upgrade Now',
    checkout_upgrade_desc: 'Your transformation starts here. Secure payment handled by PayPal.',
    checkout_verifying: 'Verifying transaction...',
    checkout_verifying_desc: 'We are confirming your subscription with the secure gateway. Do not close this window.',
    checkout_welcome_elite: 'Welcome to Elite!',
    checkout_success_desc: 'Your payment has been processed successfully. Here is your digital receipt.',
    checkout_receipt_id: 'Receipt ID',
    checkout_date: 'Date',
    checkout_amount_paid: 'Amount Paid',
    checkout_verified_payment: 'Verified Payment',
    checkout_save_pdf: 'Save PDF',
    checkout_go_dashboard: 'Go to Dashboard',
    checkout_encrypted: '256-bit SSL Encrypted',
  ...
  es: {
    ...
    checkout_secure_checkout: 'Pago Seguro',
    checkout_upgrade_now: 'Mejorar Ahora',
    checkout_upgrade_desc: 'Tu transformación comienza aquí. Pago seguro manejado por PayPal.',
    checkout_verifying: 'Verificando transacción...',
    checkout_verifying_desc: 'Estamos confirmando tu suscripción con la pasarela segura. No cierres esta ventana.',
    checkout_welcome_elite: '¡Bienvenido a Elite!',
    checkout_success_desc: 'Tu pago ha sido procesado con éxito. Aquí tienes tu comprobante digital.',
    checkout_receipt_id: 'ID de Recibo',
    checkout_date: 'Fecha',
    checkout_amount_paid: 'Monto Pagado',
    checkout_verified_payment: 'Pago Verificado',
    checkout_save_pdf: 'Guardar PDF',
    checkout_go_dashboard: 'Ir al Dashboard',
    checkout_encrypted: 'Cifrado SSL de 256 bits',
