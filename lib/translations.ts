...
const t: Record<LangCode, Translations> = {
  en: {
    ...
    prof_age: 'Age', prof_sex: 'Sex', prof_sex_male: 'Male', prof_sex_female: 'Female',
    prof_weight: 'Weight', prof_height: 'Height', prof_activity: 'Activity', prof_goal: 'Goal',
    prof_member_since: 'Member since',
    prof_logout_confirm: 'Logout confirmed',
    prof_update_success: 'Profile updated successfully',
    prof_update_error: 'Error updating profile',
    art_loading: 'Loading articles...',
  ...
  es: {
    ...
    prof_age: 'Edad', prof_sex: 'Sexo', prof_sex_male: 'Hombre', prof_sex_female: 'Mujer',
    prof_weight: 'Peso', prof_height: 'Altura', prof_activity: 'Actividad', prof_goal: 'Objetivo',
    prof_member_since: 'Miembro desde',
    prof_logout_confirm: 'Sesión cerrada',
    prof_update_success: 'Perfil actualizado correctamente',
    prof_update_error: 'Error al actualizar el perfil',
    art_loading: 'Cargando artículos...',
